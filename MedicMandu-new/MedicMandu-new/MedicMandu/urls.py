...
from admin.views import admin_dashboard_view , viewcustomer ,updatecustomer ,adminmedicineview ,deletecustomer ,adminaddmedicineview ,deletemedicineview , updatemedicineview
...
from admin.views import viewbooking , updatebookingview , deleteorderview
urlpatterns = [
